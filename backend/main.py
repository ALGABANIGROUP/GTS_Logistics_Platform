...
reports_real_data_router = _try_import_router("backend.routes.reports_real_data", "routes.reports_real_data")
bots_mock_api_router = _try_import_router("backend.routes.bots_mock_api", "routes.bots_mock_api")
...
email_ai_stats_router = _try_import_router("backend.routes.email_ai_stats", "routes.email_ai_stats")
email_bot_router = _try_import_router("backend.routes.email_bot_routes", "routes.email_bot_routes")
admin_users_router  = _try_import_router("backend.routes.admin_users", "routes.admin_users")
admin_unified_router = _try_import_router("backend.routes.admin_unified", "routes.admin_unified")
policy_context_router = _try_import_router("backend.routes.policy_context", "routes.policy_context")
bots_available_router = _try_import_router("backend.routes.bots_available", "routes.bots_available")
bots_available_enhanced_router = _try_import_router("backend.routes.bots_available_enhanced", "routes.bots_available_enhanced")
customer_service_router = _try_import_router("backend.routes.customer_service_api", "routes.customer_service_api")
...
drivers_management_router = _try_import_router("backend.routes.drivers_management_routes", "routes.drivers_management_routes")
safety_fleet_router = _try_import_router("backend.routes.fleet_management_routes", "routes.fleet_management_routes")
fleet_live_router = _try_import_router("backend.routes.fleet_live_routes", "routes.fleet_live_routes")
documents_upload_router = _try_import_router("backend.routes.documents_upload_routes", "routes.documents_upload_routes")
safety_router = _try_import_router("backend.routes.safety_api", "routes.safety_api")
frontend_compat_router = _try_import_router("backend.routes.frontend_compat_routes", "routes.frontend_compat_routes")
ai_maintenance_chat_router = _try_import_router("backend.routes.ai_maintenance_chat", "routes.ai_maintenance_chat")
bot_os_router = _try_import_router("backend.routes.bot_os", "routes.bot_os")
transport_laws_router = _try_import_router("backend.routes.transport_laws", "routes.transport_laws")
ai_bots_router = _try_import_router("backend.routes.ai_bots_routes", "routes.ai_bots_routes")
bot_learning_router = _try_import_router("backend.routes.bot_learning_routes", "routes.bot_learning_routes")
ws_live_router = _try_import_router("backend.routes.ws_routes", "routes.ws_routes")
weather_router = _try_import_router("backend.routes.weather", "routes.weather")
notifications_router = _try_import_router("backend.routes.notifications_api", "routes.notifications_api")
freight_market_rates_router = _try_import_router("backend.routes.freight_market_rates", "routes.freight_market_rates")
webhooks_router = _try_import_router("backend.routes.webhooks", "routes.webhooks")
...
enhanced_call_router = _try_import_router("backend.routes.call_webhooks", "routes.call_webhooks")
