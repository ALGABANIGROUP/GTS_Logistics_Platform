...
Manages load bookings, carrier matching, and rate optimization.
"""
...
class FreightBookingsBot:
    """Freight Bookings - Load management and carrier optimization"""
    
    def __init__(self):
        self.name = "freight_bookings"
        self.display_name = "🚛 Freight Bookings"
        self.description = "Manages load bookings, carrier matching, and rate optimization"
        self.version = "1.0.0"
