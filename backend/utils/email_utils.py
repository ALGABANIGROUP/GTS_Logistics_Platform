...
BOT_EMAIL_MAPPING = {
    ...
    "training_bot": "no-reply@gabanilogistics.com",
    "trainer_bot": "no-reply@gabanilogistics.com",
    "system_bot": "no-reply@gabanilogistics.com",
    "system_manager_bot": "no-reply@gabanilogistics.com",
}
