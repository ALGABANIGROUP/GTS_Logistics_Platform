...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('category', postgresql.ENUM('technical', 'billing', 'account', 'general', 'feature_request', 'bug_report', name='support_ticket_category'), nullable=False),
        sa.Column('priority', postgresql.ENUM('critical', 'high', 'medium', 'low', name='support_ticket_priority'), nullable=False),
        sa.Column('status', postgresql.ENUM('open', 'in_progress', 'waiting_customer', 'resolved', 'closed', 'reopened', name='support_ticket_status'), default='open'),
        sa.Column('channel', postgresql.ENUM('email', 'live_chat', 'phone', 'whatsapp', 'telegram', 'portal', name='support_channel_type'), default='portal'),
        sa.Column('sla_response_due', sa.DateTime(), nullable=False),
        sa.Column('sla_resolution_due', sa.DateTime(), nullable=False),
        sa.Column('sla_status', postgresql.ENUM('compliant', 'at_risk', 'breached', name='support_sla_status'), default='compliant'),
