...
These documents summarize the latest codebase changes and the immediate engineering direction.

## Current Development Priorities

- Keep bot registries aligned between frontend and backend
- Keep payment aliases and routing unambiguous
- Keep partner, finance, and payment documentation synchronized with real routes
- Reduce stale roadmap language in active subsystem docs
