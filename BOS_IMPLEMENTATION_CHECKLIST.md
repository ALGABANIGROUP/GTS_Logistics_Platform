...
BOS documentation now reflects the current platform control model: admin workflows, readiness gates, AI bot orchestration, and maintenance operations.

## Current Status

- Maintenance and governance panels remain available
- Bot routing and readiness checks are integrated into the frontend
- BOS should be read as operational control guidance, not only as architecture theory
