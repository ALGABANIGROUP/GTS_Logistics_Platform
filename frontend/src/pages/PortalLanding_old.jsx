...
<div className="space-y-3">
  <div className="flex items-start gap-3">
    ...
    <p className="text-gray-300 text-sm">Market Conditions Map - Real-time regional conditions to guide rate decisions</p>
  </div>
  <div className="flex items-start gap-3">
    <span className="text-yellow-400 text-xs">UPDATED</span>
    <p className="text-gray-300 text-sm">Load Popularity feature now prioritizes loads with less competition</p>
  </div>
  <div className="flex items-start gap-3">
    <span className="text-blue-400 text-xs">COMING</span>
    <p className="text-gray-300 text-sm">AI-powered carrier matching - Launching August 2026</p>
  </div>
</div>
          </div >
        </div >
  ...
  < div className = "container mx-auto px-4 py-16" >
          <h2 className="text-white text-3xl font-bold text-center mb-8">What type of trucking business are you?</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {/* Carrier Card */}
            <div className="bg-black/40 backdrop-blur-sm rounded-xl p-6 text-center border border-white/20 hover:border-red-500 transition">
              ...
              <h3 className="text-white text-xl font-bold mb-2">I am a Carrier</h3>
              <p className="text-gray-300 text-sm mb-4">Find loads & get paid faster</p>
              <Link to="/carrier" className="text-red-400 hover:underline">See tools →</Link>
            </div>
            ...
            <div className="bg-black/40 backdrop-blur-sm rounded-xl p-6 text-center border border-white/20 hover:border-red-500 transition">
              ...
              <h3 className="text-white text-xl font-bold mb-2">I am a Broker</h3>
              <p className="text-gray-300 text-sm mb-4">Fill capacity & reduce risk</p>
              <Link to="/broker" className="text-red-400 hover:underline">See tools →</Link>
            </div>
            ...
            <div className="bg-black/40 backdrop-blur-sm rounded-xl p-6 text-center border border-white/20 hover:border-red-500 transition">
              ...
              <h3 className="text-white text-xl font-bold mb-2">I am a Shipper</h3>
              <p className="text-gray-300 text-sm mb-4">Streamline operations</p>
              <Link to="/shipper" className="text-red-400 hover:underline">See tools →</Link>
            </div>
          </div>
        </div >
  ...
  {/* Pricing Plans */ }
  < div className = "container mx-auto px-4 py-16" >
          <h2 className="text-white text-3xl font-bold text-center mb-8">Truckstop Load Board Plans</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {/* Basic Plan */}
            <div className="bg-black/40 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              <h3 className="text-white text-xl font-bold mb-2">Basic</h3>
              <p className="text-gray-300 text-sm mb-4">Everything you need to start</p>
              <p className="text-3xl text-white font-bold mb-4">$42 <span className="text-sm text-gray-400">/month*</span></p>
              <ul className="space-y-2 mb-6">
                <li className="text-gray-300 text-sm">✓ Load Search</li>
                <li className="text-gray-300 text-sm">✓ Truck Post</li>
                <li className="text-gray-300 text-sm">✓ Basic Rate Insights</li>
              </ul>
              <Link to="/pricing/basic" className="block text-center py-2 border border-white/30 text-white rounded hover:bg-white/10 transition">Start now</Link>
            </div>
            ...
            <div className="bg-red-600/20 backdrop-blur-sm rounded-xl p-6 border border-red-500">
              <h3 className="text-white text-xl font-bold mb-2">Pro</h3>
              <p className="text-gray-300 text-sm mb-4">Level up your profits</p>
              <p className="text-3xl text-white font-bold mb-4">$159 <span className="text-sm text-gray-400">/month*</span></p>
              <ul className="space-y-2 mb-6">
                <li className="text-gray-300 text-sm">✓ Everything in Basic</li>
                <li className="text-gray-300 text-sm">✓ Advanced Rate Insights</li>
                <li className="text-gray-300 text-sm">✓ Book It Now</li>
                <li className="text-gray-300 text-sm">✓ Real-Time Live Loads</li>
              </ul>
              <Link to="/pricing/pro" className="block text-center py-2 bg-red-600 text-white rounded hover:bg-red-700 transition">Start now</Link>
            </div>
            ...
            <div className="bg-black/40 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              <h3 className="text-white text-xl font-bold mb-2">Premium</h3>
              <p className="text-gray-300 text-sm mb-4">Maximum efficiency</p>
              <p className="text-3xl text-white font-bold mb-4">$369 <span className="text-sm text-gray-400">/month*</span></p>
              <ul className="space-y-2 mb-6">
                <li className="text-gray-300 text-sm">✓ Everything in Pro</li>
                <li className="text-gray-300 text-sm">✓ Carrier Monitoring</li>
                <li className="text-gray-300 text-sm">✓ Predictive Sourcing</li>
                <li className="text-gray-300 text-sm">✓ Multi-Trip Search</li>
              </ul>
              <Link to="/pricing/premium" className="block text-center py-2 border border-white/30 text-white rounded hover:bg-white/10 transition">Start now</Link>
            </div>
          </div>
          <p className="text-center text-gray-400 text-xs mt-4">*Amount shown excludes applicable fees and taxes.</p>
        </div >

  {/* Footer */ }
  < div className = "container mx-auto px-4 py-6 border-t border-white/20 mt-12" >
    <p className="text-gray-400 text-sm text-center">
      Gabani Transport Solutions LLC – All rights reserved.
    </p>
        </div >
      </div >
    </div >
