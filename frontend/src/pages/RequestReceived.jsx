...
export default function RequestReceived() {
  ...
  return (
    <div
      className="min-h-screen flex flex-col items-center justify-center px-4 py-8 fixed inset-0"
    ...
    >
      <div className="bg-white/80 rounded-xl shadow-lg p-8 max-w-md w-full flex flex-col items-center">
        <div className="text-2xl font-bold text-emerald-700 mb-2">Access request submitted</div>
        <div className="text-slate-700 mb-4 text-center">
          Registration submitted successfully. Please wait up to 72 hours while our security team validates your access.
          <br />
          Request ID: <span className="font-mono text-emerald-900">{requestId || "-"}</span>
        </div>
