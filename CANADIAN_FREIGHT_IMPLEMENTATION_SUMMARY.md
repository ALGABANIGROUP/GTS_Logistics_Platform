# Canadian Freight Implementation Summary
...
- Updated bot alias handling so payment and partner routes resolve consistently.
        ...
        ## International Integration Scope

International logistics documentation remains focused on MapleLoad Canada and the broader Canadian freight integration layer.

## Current Notes

- This documentation set is refreshed to align with the current platform routing and frontend structure
- International modules remain distinct from the new payment and finance bot additions
