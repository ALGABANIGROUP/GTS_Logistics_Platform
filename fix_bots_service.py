...
class BotFixer:
    def __init__(self):
        ...
        self.required_bots = [
            ...
            ('legal_consultant', 'AI Legal Consultant', 'Legal Consultant', 'legal@gabanilogistics.com', 'legal'),
            ...
            ('security', 'AI Security Manager', 'Security Manager', 'security@gabanistore.com', 'security'),
            ...
            ('legal_counsel', 'AI Legal Counsel', 'Legal Counsel', 'legal@gabanilogistics.com', 'legal'),
            ('safety', 'AI Safety', 'Safety', 'safety@gabanilogistics.com', 'safety'),
            ('security_bot', 'AI Security Bot', 'Security Bot', 'security@gabanistore.com', 'security'),
