...
- Margins: 2.5 cm top and bottom, 2.0 cm left and right
- Font: Times New Roman, 12 pt
- Line spacing: 1.5 to 2.0
- Page numbers: bottom center
- Export target: PDF for filing package assembly

## Filing Draft Status
This document is a filing-ready working draft for conversion to PDF and legal review before submission to the Canadian Intellectual Property Office. Applicant identity, inventorship, entitlement, and fee status should be confirmed on the filing date.
...
## Assembly Notes
- Keep the abstract on its own page or at the beginning of the specification, depending on export style.
- Keep total claims at 20 or fewer if you want to avoid excess-claim fees.
- Do not upload the internal evidence memo with the filed specification.
