# Api Connections Implementation Summary
...
- Updated bot alias handling so payment and partner routes resolve consistently.
        ...
        ## API Connections Scope

The API connection layer covers route catalogs, integration entry points, and operational manager views.

## Current Focus Areas

- Payment gateway APIs
- Finance and invoice endpoints
- Carrier and shipper APIs
- Bot availability and subscription endpoints
- Learning and orchestration routes for bot workflows

## Documentation Guidance

Use these API documents as implementation references, not as generated OpenAPI replacements.
